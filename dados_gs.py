...
Original file is located at
    https://colab.research.google.com/drive/1ubV8gxJTEQs7GEz8n7sJu97iuAEfFfT8
"""
...
search_query = scholarly.search_author('Rute Morais Nogueira Bicalho')

# Iterate through the results and handle the case when no results are found.
for author in search_query:
    # Author information is already a filled dictionary
    print(author)
else:
...
# Lista de proxies (use a lista fornecida no lugar deste exemplo)
proxies = [
...
Recomendações baseadas nessa análise:
